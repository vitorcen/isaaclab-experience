...
**🔬 尾点复测 27k/30k(2026-06-14,答"3.3ep后是否二次爬升")**:用归档 delta 重建 27k/30k(708keys GOLD验)→ 本地 5-round。**27k(3ep)=11/15=73.3%(placed 1/3/3/3/1)= 与 21k 峰持平!** → 推翻"21k见顶后回落":**24k=46.7% 是噪声坑,trunc 在 21k-27k 维持高平台,3.3ep 还没过拟合塌**。**含义:batch4 只训 3.3ep 偏浅(冻结家族 6.6ep),续训到 6ep 可能还有空间——之前"3.3ep够/21k是峰"结论需软化为"21k-27k 平台、未见顶部回落"**。**✅ 30k(3.3ep)=12/15=80.0%(placed 3/3/3/2/1,2026-06-14 21:39,本机重启清 load=129 wedge 后跑)= 全曲线最高点!** → **决定性反转"21k见顶后回落"**:尾点 21k=73.3 / 24k=46.7(噪声坑)/ 27k=73.3 / **30k=80.0**,**末 ckpt(3.3ep)反而最高、零过拟合塌、仍在向上**。**答用户"确定后续没再爬升机会吗"=否,有继续爬升迹象**:batch4 只 3.3ep 偏浅(冻结家族 6.6ep),30k 是最后一个 ckpt 还在涨 → **续训到 6ep 很可能再提升,值得考虑(需用户拍板花 box 钱 + 20-round 复核)**。**5-round 噪声大(σ±18%),80% 实际约 ~66-72,但趋势(21/27/30 全 ≥73,仅 24 坑)稳健=无衰减**。tail-eval loop 已结束。**wedge 教训**:eval daemon 反复 restart + setsid 子进程杀不净 → 孤儿堆积 load 129 / ps·fuser·/proc-cmdline 全 hang → 只能重启清,见 [[feedback-shared-gpu-eval-queue-orphan-discipline]]。
